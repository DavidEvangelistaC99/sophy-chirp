...
- `rx/`: USRP-based data acquisition scripts, storing
  received data in HDF5 format
- `processing/`: signal processing scripts, including Doppler spectrum estimation and PPI generation using Pulse Pair
