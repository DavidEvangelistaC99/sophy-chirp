    ...
    if not conf['usrp_tx']['enable_2']: # One Pulse
        ...
        for param in parameters:
            ...
            if args.save:
                ...
                # meta
                writer.addParameter(name='pulse_type', value=conf['usrp_tx']['code_type_1'].rsplit('_', 1)[0])
        ...
        if '2' in args.pulses:
            ...
            if conf['usrp_tx']['code_type_2']:
                ...
                if conf['usrp_tx']['code_type_2'] == 'CHIRP':
                    ...
                    chirp_tx_2, _ = modf.chirpMod(A2, ipp2, dc2, sr_rx2, sr_rx2, fc2, bw2, t_d = 0, window = window2, mode_f = 0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--angles', nargs='*', default=[], type=float,
