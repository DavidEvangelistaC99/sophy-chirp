...
This folder contain the data acquisition script used for receiving radar
signals from a USRP device during the SOPHy experiments. The script is adapted from the `thor.py` receiver provided in the
