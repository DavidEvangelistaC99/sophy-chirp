...
class Thor(object):
    ...
    def __init__(self, datadir, **kwargs):
        options = dict(
            ...
            mboards=[],
            subdevs=["A:A"],
            clock_rates=[None], #Change
            clock_sources=[""], #Change
            time_sources=[""], 	#Change
            ...
            lo_sources=[""],
            lo_exports=[None],
            dc_offsets=[False],	#Change
            iq_balances=[None],	#Change
            gains=[0],
            bandwidths=[0],
            antennas=[""],
...
# python3 thorNew.py -m 192.168.10.5 -d "A:AB" -c ch0 -y "RX" -f 70312500 -r 5000000 /home/idi/data_freq/tx_20_rx_5/fc_-1.1_bw_2.2/dc_15
